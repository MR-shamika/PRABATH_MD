...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.imgur.com/PJU60wn.mp4'
module.exports = {
  OPENAI_API_KEY:process.env.OPENAI_API_KEY || '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',
  botname: process.env.BOT_NAME || 'SHAMIKA-MD',
  dl_limit: process.env.DL_SIZE || '300',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '94762280384',
  alivepic: process.env.ALIVE_IMG || 'https://i.imgur.com/PJU60wn.mp4',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY SHAMIKA-MD* 🎊',
  ownername:process.env.OWNER_NAME || 'SHAMIKA',
